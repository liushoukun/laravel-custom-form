...
class CustomFormServiceProvider extends ServiceProvider
{
    ...
    {
        // $this->loadTranslationsFrom(__DIR__.'/../resources/lang', 'dawn');
    ...
    protected function bootForConsole()
    {
        ...
        /*$this->publishes([
            __DIR__.'/../resources/views' => base_path('resources/views/vendor/dawn'),
        ], 'customform.views');*/

        // Publishing assets.
        /*$this->publishes([
            __DIR__.'/../resources/assets' => public_path('vendor/dawn'),
        ], 'customform.views');*/

        // Publishing the translation files.
        /*$this->publishes([
            __DIR__.'/../resources/lang' => resource_path('lang/vendor/dawn'),
        ], 'customform.views');*/
